...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.create_date'
        db.add_column('c_portal_tag', 'create_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 1, 12, 0, 0), auto_now_add=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.create_date'
        db.delete_column('c_portal_tag', 'create_date')
    ...
    models = {
        'c_portal.article': {
            ...
            'mod_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 12, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['c_portal.Project']", 'null': 'True', 'blank': 'True'}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 12, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'c_portal.tag': {
            ...
            'create_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 12, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
