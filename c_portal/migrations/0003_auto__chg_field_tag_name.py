...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('c_portal_tag', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=24))

    def backwards(self, orm):

        # Changing field 'Tag.name'
        db.alter_column('c_portal_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=16, unique=True))
