...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('polls_poll_participants', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('poll', models.ForeignKey(orm['polls.poll'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('polls_poll_participants', ['poll_id', 'user_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('polls_poll_participants')
    ...
    models = {
        ...
        'polls.poll': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participants': ('django.db.models.fields.related.ManyToManyField', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'symmetrical': 'False'}),
